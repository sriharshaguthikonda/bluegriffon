...
{
  if (!gDialog || !gDialog.FormatToolbox || !gDialog.formatToolboxLeftDock || !gDialog.formatToolboxRightDock)
    return;
  ...
  var toolbox = gDialog.FormatToolbox;
  ...
  if (toolbox.parentNode != targetDock)
    targetDock.appendChild(toolbox);
